...
const pokemonPageBreedingTable = document.getElementById('pokemonPageBreedingTable')
...
function convertPokemonPageMainContent(pokemon) {
    return `
            ...
            ${pokemon.types
            .map(type => `<li class="pokemonPageType ${type}">${type}</li>`).join('')}
            </ol>
            `
}
